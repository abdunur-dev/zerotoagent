...
const Index = () => {
  ...
  return (
    <main className="deck-scroll bg-background text-foreground selection:bg-accent selection:text-accent-foreground">
      <nav className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-4 py-4 md:px-10 md:py-6">
      ...
      <section id="hero" className="slide-shell vercel-grid relative flex items-center justify-center px-4 pt-20 sm:px-6 md:pt-24" onMouseMove={(e) => {
        ...
        <div className="relative mx-auto flex max-w-6xl animate-fade-up flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-xs font-mono text-xs uppercase tracking-[0.14em] text-muted-foreground sm:max-w-none md:mt-8 md:text-base md:tracking-[0.18em]">Vercel Team Message · O2A Global Build Week</p>
          <div className="mt-7 flex flex-col items-center divide-border text-base sm:text-lg md:mt-10 md:flex-row md:divide-x">
